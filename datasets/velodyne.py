...
def velodyne_raw_to_pointcloud(ranges: np.ndarray, intensities: np.ndarray, angles: np.ndarray):
    ...
    ptcld = np.stack((xf, yf, zf, intensityf), 1)

    return ptcld

# ranges, intensity, angles, approximate_timestamps = load_velodyne_raw("/media/mav-lab/1T/Datasets/bypy/01.10/2019-01-10-12-32-52-radar-oxford-10k/velodyne_left/1547123579957366.png")
# ptcld = velodyne_raw_to_pointcloud(ranges, intensity, angles)